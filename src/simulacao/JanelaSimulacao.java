...
public class JanelaSimulacao extends JFrame {
    ...
    /**
     * Fornece uma visualizacao grafica do mapa. Esta eh uma classe interna que
     * define os componentes da GUI. Ela contém alguns detalhes mais avancados
     * sobre GUI que voce pode ignorar para realizacao do seu trabalho.
     */
    private class VisaoMapa extends JPanel {
        ...
        /**
         * Prepara para um novo ciclo de exibicao. Uma vez que o componente pode
         * ser redimensionado, calcula o "fator de escala" novamente.
         */
        ...
        /**
         * O componente VisaoMapa precisa ser reexibido. Copia a imagem interna
         * para a tela.
         */
