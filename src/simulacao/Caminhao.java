...
public class Caminhao extends ItemMovel {
    ...
    public Caminhao(Localizacao localizacao) {
        super(localizacao);
        setImagem(new ImageIcon(getClass().getResource("Imagens/caminhao.png")).getImage());
    ...
    /**
     * Descarrega a mercadoria na loja, declara posição destino para a próxima
     * mercadoria do Array.
     */
    ...
    /**
     * Coleta uma mercadoria, declara a posição de destino para a Loja na qual a
